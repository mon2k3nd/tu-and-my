...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Thảo My & Xuân Tú" },
      { name: "description", content: "Thiệp cưới của Thảo My và Xuân Tú — 03.10.2026" },
      { name: "author", content: "Thảo My & Xuân Tú" },
      { property: "og:title", content: "Thảo My & Xuân Tú" },
